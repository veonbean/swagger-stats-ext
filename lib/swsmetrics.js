...
class SwsMetrics {
    ...
    constructor() {
        ...
        this.apiMetricsDefs = {
            ...
            // API mcall counters, labeled with service, method, path, http_status_code, code
            mcall_request_total: {
                type: 'counter',
                help: 'The total number of all mcall based on http protocol requests',
                labelNames: ['service', 'method', 'path', 'http_status_code', 'code']
            },
